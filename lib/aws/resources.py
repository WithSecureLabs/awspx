...
class Resources(dict):
    ...
    types = {
        ...
        "AWS::Ec2::VpnConnection":                          "arn:aws:ec2:{Region}:{Account}:vpn-connection/{VpnId}",
        "AWS::Ec2::VpnGateway":                             "arn:aws:ec2:{Region}:{Account}:vpn-gateway/{VgwId}",
        ...
        # "AWS::MediaPackage::Origin_Endpoint":               "arn:aws:mediapackage:{Region}:{Account}:{Channels}/{ChannelId}",
